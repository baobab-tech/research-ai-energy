...
| # | Source | Insight | Link |
|---|--------|---------|------|
| 001 | Jiang et al., 2024 | LLM carbon analysis must span 8 lifecycle phases: training, fine-tuning, hardware manufacturing, operations, recycling | [file](001-jiang-2024-llm-lifecycle-footprint.md) |
...
| 002 | Tomlinson et al., 2024 | AI emits 130-1500x less CO2 per page than humans, BUT doesn't account for rebound effects or displacement | [file](002-tomlinson-2024-ai-vs-human-emissions.md) |
...
| 004 | Barbierato & Gatti, 2024 | "Red AI" vs "Green AI" - trade-off between accuracy/performance and sustainability is unavoidable | [file](004-barbierato-2024-green-ai-survey.md) |
